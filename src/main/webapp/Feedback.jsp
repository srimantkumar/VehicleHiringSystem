...
<font color=white>Customer_id:</font> <input type="text" name="cust_id" value ="${cust_id}" readonly="readonly"  required="required"><br><br>
	
    <font color=white>Message :</font> <input type="text" required="required" name="msg" ><br><br>
