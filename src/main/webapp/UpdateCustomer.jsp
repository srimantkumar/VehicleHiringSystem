...
<center>
	...
	<table>
	<tr>
	<td>CustomerID<input type="text" name="customer_id"  value="${customer.customer_id}"></td><br>
<td>Name<input type="text" name="Name" value="${customer.Name}"></td><br>
<td>Contact Number<input type="text" name="contact_no" value="${customer.contact_no}"></td><br>
<td>Password<input type="text" name="password" value="${customer.password}"></td><br>
</tr>
<tr>
<td><input type="Submit" values="Update">M</td>
<a href=    >
</a>
</form>
</font>
